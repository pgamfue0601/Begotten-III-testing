...
RANDOM_FORENAMES = {
	["glazic"] = {
		["male"] = {"Adrian", "Alberto", "Alejandro", "Alfonso", "Alvaro", "Andres", "Angel", "Antonio", "Carlos", "Cesar", "Cristian", "Daniel", "David", "Diego", "Eduardo", "Emilio", "Enrique", "Fernando", "Francisco", "Gabriel", "Gonzalo", "Guillermo", "Gustavo", "Hector", "Ignacio", "Ivan", "Javier", "Jesus", "Joaquin", "Jorge", "Jose", "Juan", "Julio", "Leonardo", "Luis", "Manuel", "Marcos", "Mario", "Martin", "Miguel", "Nicolas", "Oscar", "Pablo", "Patricio", "Pedro", "Rafael", "Ramon", "Raul", "Ricardo", "Roberto", "Rodrigo", "Ruben", "Salvador", "Samuel", "Santiago", "Sebastian", "Sergio", "Tomas", "Vicente", "Victor"},
		["female"] = {"Adela", "Adriana", "Alicia", "Amelia", "Amparo", "Ana", "Beatriz", "Carolina", "Catarina", "Cecilia", "Eleanor", "Elizabeth", "Emma", "Gloria",  "Elena", "Isabel", "Isabela", "Jennifer", "Juana", "Julia", "Juliana", "Laura", "Livia", "Margarita", "Maria", "Sara", "Silvia", "Sofia", "Susana", "Teodora", "Victoria", "Virginia", "Valeria"}
	},
	["gore-glazic"] = {
	...
	["goreic"] = {
		["male"] = {"Aitor", "Ander", "Andoni", "Aritz", "Aimar", "Asier", "Benat", "Eneko", "Gaizka", "Gorka", "Haritz", "Hodei", "Iker", "Imanol", "Jon", "Josu", "Julen", "Kepa", "Koldo", "Lander", "Markel", "Mikel", "Oihan", "Oier", "Patxi", "Peru", "Txomin", "Unai", "Xabier", "Yeray", "Zigor"},
...
RANDOM_SURNAMES = {
	["glazic"] = {
		"Alonso", "Alvarez", "Arias", "Benitez", "Blanco", "Cabrera", "Calvo", "Campos", "Cano", "Carmona", "Carrasco", "Castillo", "Castro", "Delgado", "Diaz", "Dominguez", "Duran", "Fernandez", "Ferrer", "Flores", "Fuentes", "Galan", "Gallardo", "Garcia", "Garrido", "Gil", "Gimenez", "Gomez", "Gonzalez", "Guerrero", "Gutierrez", "Hernandez", "Herrera", "Iglesias", "Jimenez", "Lopez", "Lorenzo", "Marin", "Martinez", "Medina", "Mendez", "Molina", "Montero", "Morales", "Moreno", "Muñoz", "Navarro", "Nunez", "Ortega", "Ortiz", "Parra", "Perez", "Prieto", "Ramirez", "Ramos", "Reyes", "Rivas", "Rivera", "Robles", "Rodriguez", "Romero", "Rubio", "Ruiz", "Sanchez", "Santos", "Serrano", "Suarez", "Torres", "Vargas", "Vazquez", "Vega", "Velasco", "Vicente"
	},
	["gore-glazic"] = {
	...
	["goreic"] = {
		"Agirre", "Aguirre", "Alberdi", "Aldana", "Aramburu", "Aranzabal", "Arizmendi", "Arrieta", "Astigarraga", "Azpeitia", "Azpillaga", "Barandiaran", "Basauri", "Belaustegui", "Berenguer", "Bidasoa", "Echeverria", "Elorriaga", "Etcheverry", "Eulate", "Garay", "Garikoitz", "Goikoetxea", "Ibañez", "Ibargaray", "Ibarrola", "Irastorza", "Irizar", "Iturralde", "Larrañaga", "Larrazabal", "Lekuona", "Mendizabal", "Olazabal", "Olaziregui", "Otxoa", "Sagardoy", "Ugarte", "Uriarte", "Urrutia", "Zabaleta", "Zabala", "Zubizarreta"
	}
};
